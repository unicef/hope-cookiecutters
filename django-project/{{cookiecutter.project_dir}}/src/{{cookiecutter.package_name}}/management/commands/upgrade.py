...
from {{ cookiecutter.package_name }}.config import env
...
class Command(BaseCommand):
    ...
    def handle(self, *args: Any, **options: Any) -> None:  # noqa: C901
        from {{ cookiecutter.package_name }}.models import User  # noqa: PLC0415
        ...
        try:
            ...
            echo(f"Running upgrade of version {{'{'}}{{ cookiecutter.package_name }}.VERSION{{'}'}}", style_func=self.style.WARNING)
